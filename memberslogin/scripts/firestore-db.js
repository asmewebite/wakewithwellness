                 ...
                 const userInfo = doc.data()
                    if(userInfo){
                       ...
                       <div style="text-align:left;padding-left:5px;padding-right:5px">
                        <ul>
                        <li>* Post attendance on or before 30th November 2021 without fail</li>
...
function updateattendance(event){
  ...
  var Nov2 = document.getElementById('attend').value
  var Nov2f = document.getElementById('work').value
