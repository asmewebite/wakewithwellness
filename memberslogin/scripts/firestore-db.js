                 ...
                 const userInfo = doc.data()
                    if(userInfo){
                       ...
                       <div style="text-align:left;padding-left:5px;padding-right:5px">
                        <ul>
                        <li>* August timeline suggestion <a href="../timelinesuggestions.html">Click</a></li>
...
function updateattendance(event){
  ...
  var July4 = document.getElementById('attend').value
  var July4f = document.getElementById('work').value
