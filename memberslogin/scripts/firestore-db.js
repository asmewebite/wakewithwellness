                 ...
                 const userInfo = doc.data()
                    if(userInfo){
                       ...
                       <div style="text-align:left;padding-left:5px;padding-right:5px">
                        <ul>
                        <li>* Post attendance on or before 15th September 2021 without fail</li>
...
function updateattendance(event){
  ...
  var Sept1 = document.getElementById('attend').value
  var Sept1f = document.getElementById('work').value
