        ...
        <div class="content">
            <div class="row">
                ...
                <div class="col-sm-5 col-6 text-right m-b-30">
                    <a href="activities.html" style="background-color:cornflowerblue;padding:10px;color:white;border"> <i class="fa fa-home"></i> Home</a>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="profile-img" >
                            ...
                            <div class="profile-basic" style="margin-bottom:8vh">
                                <div class="row">
                                    <div class="col-md-5">
