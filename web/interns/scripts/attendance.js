...
async function getuserInfoRealtime(userID){
 ...
 <div class="page-wrapper">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <h1 style="color: cornflowerblue;text-align: center;">WEEKLY ATTENDANCE</h1>
                          ...
                          <h4 style="color: rgb(173, 137, 137);font-weight: 200;">I, <span style="color:red;font-weight:500">${userInfo.name} [${userInfo.regno}]</span> post my attendance for the <span style="font-weight: 500;">Second half of January</span> <span style="font-size: 14px;color: tomato;">[11/01/2022 - 17/01/2022]</span></h4>
        ...
        border-bottom: 1px solid transparent; border-color: cornflowerblue;background: #000;">
            <h2 id="form_header" style="display: inline-block; font-size: 15px;font-family: Bowlby One SC;
            font-weight: 900;  text-transform: uppercase;letter-spacing: 1px; background-color: rgb(255, 255, 255);-webkit-background-clip: text;-webkit-text-fill-color: transparent;"> INTERN PORTAL </h2>
        </div>
...
function updateattendance(event){
    ...
    var Jan2 = document.getElementById('attend').value
    var Jan2f = document.getElementById('work').value
   ...
   document.getElementById('attendanceform').reset();
     ...
     var countDownDate = new Date("January 18, 2022 23:00:00").getTime();
